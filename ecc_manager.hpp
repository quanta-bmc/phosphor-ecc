...
#include <com/quanta/Memory/MemoryECC/server.hpp>
namespace phosphor
{
namespace memory
{
...
using EccInterface = sdbusplus::com::quanta::Memory::server::MemoryECC;
using EccObject = ServerObject<EccInterface>;
/** @class 
 *  @brief Manages ECC
 */
class ECC : sdbusplus::server::object::object<
                sdbusplus::com::quanta::Memory::server::MemoryECC>
{
  public:
    ECC() = delete;
    ~ECC() = default;
    ...
    ECC(sdbusplus::bus::bus &bus, const std::string &objPath) :
            sdbusplus::server::object::object<
                sdbusplus::com::quanta::Memory::server::MemoryECC>(bus, objPath.c_str()),
